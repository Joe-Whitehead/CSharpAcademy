...
internal class NewspaperController : IBaseController
{
    public void ViewItems()
    {
        ...
        foreach (var newspaper in newspapers)
        {
            table.AddRow(
                ...
                $"[cyan]{newspaper.PublishDate:dd-MM-yyyy}[/]",
    ...
    public void AddItem()
    {
        ...
        var publishDate = AnsiConsole.Ask<DateTime>("Enter the [green]publish date[/] of the newspaper (dd-MM-yyyy):");
    ...
    {
        if (MockDatabase.LibraryItems.OfType<Newspaper>().Any())
        {
        ...
        var newspaperToDelete = AnsiConsole.Prompt(
            new SelectionPrompt<Newspaper>()
                ...
                .UseConverter(n => $"{n.Name} (Published on {n.PublishDate:dd-MM-yyyy})")
